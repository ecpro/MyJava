 ...
 */
public class WorkerMethodsSynchronized implements Runnable{
    ...
    public static void main(String args []) {
        ...
        Runnable task  = new WorkerMethodsSynchronized();
        ...
        System.out.println("List1: " + ((WorkerMethodsSynchronized)task).getList1() + "; List2: " + ((WorkerMethodsSynchronized)task).getList2());
    }
}
