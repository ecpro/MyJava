...
public class Processor {
    ...
    public void produce() throws InterruptedException {
        synchronized (this) {
            ...
            // wait releases the lock which can be used by other threads 
    ...
    public void consume() throws InterruptedException {
        ...
        synchronized (this) {
            ...
            notify();
            // notify does not release the lock. It just notifies the waiting threads.
            // the lock is only released after the completion of this sync block.
            Thread.sleep(5000);
